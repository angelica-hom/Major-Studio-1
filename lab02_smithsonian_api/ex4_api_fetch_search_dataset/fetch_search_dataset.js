...
const search =  `unit_code:"NMAAHC" AND object_type:"Photographs"`;
...
function addObject(objectData) {  
  ...
  myArray.push({
    ...
    date: objectData.content.indexedStructured.date[0]
    //date2: objectData.content.freetext.date[0].content
